![pull-scr logo](./images/k8s-scr-adm_rm.png)
...
>❗**Note**: By default, *pull-scr* is deployed in namespace```default```. If you use a different namespace, **update the export command** below:
